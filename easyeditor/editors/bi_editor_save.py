    ...
    def edit(self,
        ...
        for i, request in enumerate(requests):
            ...
            if self.alg_name == 'IKE':
                ...
                #add_weights
                #if i==1 or i==3 or i==5 or i==7 or i==11 or i==14 or i==17 or i==24 or i==34:
                #or i==149 or i==179 or i==249
                #if i==2499 or i==2999 or i==3999:

                if i==4 or i==9 or i==19 or i==29 or i==39 or i==49 or i==59 or i==79 or i==99 or i==119 or i==149 or i==179 or i==199 or i==249 or i==299 or i==499 or i==399 or i==699 or i==899 or i==999 or i==1199 or i==1299 or i==1499 or i==1599 or i==1799 or i==1999:
                    if not os.path.exists("results/{}/{}/{}".format("counter", self.hparams.alg_name, self.hparams.model_name.split("/")[-1], i)): #判断所在目录下是否有该文件名的文件夹
                        os.makedirs("results/{}/{}/{}".format("counter", self.hparams.alg_name, self.hparams.model_name.split("/")[-1], i)) #创建多级目录用mkdirs，单击目录mkdir

                    matrix_file = np.save("results/{}/{}/{}/save_{}".format("counter",self.hparams.alg_name, self.hparams.model_name.split("/")[-1], i), upd_matrixs)
