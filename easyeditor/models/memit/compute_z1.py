...
def compute_z(
    ...
    context_templates1=context_templates[1]
    #print(context_templates)
    hrt_prompts = context_templates1
    hrt_obj_prompts = [
        context.format(target_new)
        for context in context_templates1
    ]
